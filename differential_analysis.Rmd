...
rownames(name_FDR) <- get_species(tax, rownames(data.frame(name_FDR)))

rownames(output_baseMean) <- get_species(tax, rownames(data.frame(output_baseMean)))
...
species_to_select <- output_baseMean %>%
  data.frame(.) %>%
