...
otu <- otu_table(t(otu), taxa_are_rows = FALSE)
...
phy <- subset_samples(phy, non_westernized == "no")
...
phy <- get_top_taxa(phy, 15, discard_other = TRUE) ## take 10 top taxa with highest relative counts
...
plot_network(spiec.graph_species, phy, type= 'taxa', color="Species", label = NULL)
