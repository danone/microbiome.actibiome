...
net.c.w <- spiec.easi(otu.c.w[,1:100],
                    method='mb',
...
plot_network(spiec.graph_species, phy, type= 'taxa', color="Species", title='Antibiotics current use = no', label=NULL)
